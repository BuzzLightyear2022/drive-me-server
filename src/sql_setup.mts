...
export const ReservationDataModel: ModelStatic<Model<ReservationData>> = sqlConnection.define('Reservation', {
    ...
    applicantZipCode: DataTypes.INTEGER,
    applicantAddress: DataTypes.STRING,
    applicantPhoneNumber: DataTypes.INTEGER,
